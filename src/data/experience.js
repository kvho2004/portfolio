export const experience = [
  {
    ...
    bullets: [
      ...
      "Architected a webhook-based message routing system for a multi-platform AI chatbot (web, Whatsapp, Telegram) and an admin dashboard for customer support and leads capture",
    ...
    highlights: [
      ...
      "guardrails, content filtering, schema validation, rate limiting, and input sanitization",
